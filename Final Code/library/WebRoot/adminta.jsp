...
<%@ include file = "header.jsp" %><table width="830"  border="0" bgcolor="#999999" height="29">
      <tr>
        ...
        <td width="12%" class="style1">&nbsp;&nbsp; 留言<br /></td>
        <TD class="style1">&nbsp;助理管理</TD>
        </tr>
...
<td><br /><table width="120"  border="0" height="385">
          ...
          <tr>
            ...
            <td width="81%"><a href="listmember.jsp" target=_blank>查看所有助理</a></td>
          </tr>
          <tr>
            <td height="22">&nbsp;</td>
            <td><a href="message.jsp">查看所有信息</a></td>
          </tr>
          <tr>
            <td height="22">&nbsp;</td>
            <td><a href="updatemember.jsp" target=_blank>修改助理权限</a></td>
          </tr>
          <tr>
            <td height="22">&nbsp;</td>
            <td><br /></td>
