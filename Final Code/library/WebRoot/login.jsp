...
<form id="form1" name="form1" method="post" action="./servlet/CheckLogin" onsubmit="return checkForm();">
      ...
      <tr>
        <td valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="99%"><img src="img/icon_3.gif" width="16" height="16" align="absmiddle">&nbsp;<span class="px12B_blue">系统登陆页面</span></td>
          </tr>
        </table>
          ...
          <table width="352" border="0" align="center" cellpadding="0" cellspacing="0">
		    ...
		    <tr>
              <td height="125" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="img/Bg_Index.gif">
                <!--DWLayoutTable-->
                <tr>
                  <td width="141" height="45" align="center" class="px13B_gray">登&nbsp;&nbsp;录&nbsp;&nbsp;名：</td>
                  <td width="211"><input name="username" type="text" id="username" style="width:180px"></td>
                </tr>
                <tr>
                  <td height="40" align="center" class="px13B_gray">登&nbsp;录&nbsp;密&nbsp;码：</td>
		      <td><input name="password" type="password" id="password" style="width:180px"></td>
                ...
                <tr>
                  <td height="45">&nbsp;</td>
                  <td><input type="submit" name="Submit" value="提交登录"></input>&nbsp;&nbsp; <a href="register.jsp" target="_blank">注册</a></td>
		      </tr>
              </table>              </td>
              </tr>
